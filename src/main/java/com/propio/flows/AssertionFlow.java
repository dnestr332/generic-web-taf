...
import com.propio.assertions.Hardly;
...
public class AssertionFlow {
    ...
    public void verifyVisibleState(PropioPage page, PageElement element, AssertionState assertion, VisibleState visible) {
    ...
    public void verifyButtonState(PropioPage page, PageElement element, AssertionState assertion, ButtonState state) {
        Locator locator = resolve(page).locator(element);
    ...
    public void verifyFieldState(PropioPage page, PageElement element, AssertionState assertion, FieldState state) {
        Locator locator = resolve(page).locator(element);
        BooleanSupplier condition = switch (state) {
    ...
    public void verifyToggleState(PropioPage page, PageElement element, AssertionState assertion, ToggleState state) {
        Locator locator = resolve(page).locator(element);
        BooleanSupplier condition = switch (state) {
    ...
    public void verifyTextEquals(PropioPage page, PageElement element, AssertionState assertion, String expected) {
        Locator locator = resolve(page).locator(element);
    ...
    public void verifyTextContains(PropioPage page, PageElement element, AssertionState assertion, String partial) {
        Locator locator = resolve(page).locator(element);
