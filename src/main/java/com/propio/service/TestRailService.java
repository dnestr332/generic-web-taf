...
import com.propio.api.clients.TestRailApiClient;
import com.propio.config.ConfigReader;
import com.propio.context.TestFailureContext;
import com.propio.enums.TestRailStatus;
...
public class TestRailService {
    ...
    private long resolveRunId(Scenario scenario) {
        ...
        if (tags.contains("@propio")) return parseRunId("testrail.propio.runId");

        throw new IllegalStateException(
                "❌ No project tag (@propio, @jopa, etc...) found for scenario: " + scenario.getName()
        );
    }
