...
import com.generic.enums.states.AssertionState;
import com.generic.enums.states.ButtonState;
import com.generic.enums.states.FieldState;
import com.generic.enums.states.VisibleState;
import com.generic.flows.AssertionFlow;
...
import static com.generic.context.Context.COUNT;
...
public class AssertionSteps {
    ...
    public void verifyVisibility(String rawItem, AppPage page, AssertionState assertion, VisibleState visible) {
    ...
    public void verifyEnabled(String rawItem, AppPage page, AssertionState assertion, ButtonState state) {
        PageElement element = elementResolver.resolveElement(page, rawItem);
    ...
    public void fieldIsReadOnly(String rawField, AppPage page, AssertionState assertion, FieldState fieldState) {
    ...
    public void verifyTextEquals(String rawItem, AppPage page, AssertionState assertion, String expected) {
        PageElement element = elementResolver.resolveElement(page, rawItem);
    ...
    public void validateFieldValueContains(String rawItem, AppPage page, AssertionState assertion, String partialValue) {
        PageElement element = elementResolver.resolveElement(page, rawItem);
